...
var UIScene = new Phaser.Class({
				...
				temp.on('pointerdown', (pointer) => {
					...
					for (var i = 0; i < enemies.length + 1; i++) {
						if (i === enemies.length) {
							...
							var escapetext1 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, "BACK", {
								color: "#ffa500",
								align: "center",
								fontWeight: 'bold',
								font: '36px Arial',
							...
							var enemytext1 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
								color: "#ffa500",
								align: "center",
								fontWeight: 'bold',
								font: '36px Arial',
							...
							var enemytext2 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
								color: "#ffa500",
								align: "center",
								fontWeight: 'bold',
								font: '36px Arial',
							...
							var enemytext3 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
								color: "#ffa500",
								align: "center",
								fontWeight: 'bold',
								font: '36px Arial',
				...
				temp.on('pointerdown', (pointer) => {
					...
					for (var i = 0; i < currentPlayer.playerInformation.unitBattleSkills.length; i++) {
						...
						var text = this.scene.get("UIScene").add.text(410,
							...
							currentPlayer.playerInformation.unitBattleSkills[i].battleSkillDescription, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
								...
								if (currentPlayer.playerInformation.unitBattleSkills[0].type === "heal") {
									for (var i = 0; i < 4 + 1; i++) {
										if (i === 4) {
											...
											var enemytext4 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext5 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext6 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext61 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
									...
									for (var i = 0; i < enemies.length + 1; i++) {
										if (i === enemies.length) {
											//if this is the last index, create an escape button
											var escapetext2 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, "BACK", {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext4 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext5 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext6 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
								...
								if (currentPlayer.playerInformation.unitBattleSkills[1].type === "heal") {
									for (var i = 0; i < 4 + 1; i++) {
										if (i === 4) {
											...
											var enemytext7 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext8 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext9 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext91 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
									...
									for (var i = 0; i < enemies.length + 1; i++) {
										if (i === enemies.length) {
											//if this is the last index, create an escape button
											var escapetext3 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, "BACK", {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext7 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext8 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext9 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
								...
								if (currentPlayer.playerInformation.unitBattleSkills[2].type === "heal") {
									for (var i = 0; i < 4 + 1; i++) {
										if (i === 4) {
											...
											var enemytext10 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext11 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext12 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext121 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
									...
									for (var i = 0; i < enemies.length + 1; i++) {
										if (i === enemies.length) {
											...
											var enemytext10 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext11 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext12 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
								...
								if (currentPlayer.playerInformation.unitBattleSkills[3].type === "heal") {
									for (var i = 0; i < 4 + 1; i++) {
										if (i === 4) {
											...
											var enemytext13 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext14 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext15 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext151 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 60, players[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
									...
									for (var i = 0; i < enemies.length + 1; i++) {
										if (i === enemies.length) {
											//if this is the last index, create an escape button
											var escapetext4 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, "BACK", {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext13 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext14 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
											...
											var enemytext15 = this.add.text(410, 1024 - 3 * 95 - 58 + i * 80, enemies[i].unitName, {
												color: "#ffa500",
												align: "center",
												fontWeight: 'bold',
												font: '36px Arial',
	...
	battle: function (player, target, method_of_attack, skillName, isPlayer) {
		...
		if (method_of_attack === "attack") {
			...
			for (var i = 0; i < this.battleScene.enemiesArray.length; i++) {
				if (target === this.battleScene.enemiesArray[i].playerInformation) {
					...
					timedEvent = this.battleScene.time.addEvent({
						delay: 1500,
						callback: this.deleteDamageIndicator,
						callbackScope: this
					});
				}
			...
			this.scene.get('BattleScene').time.addEvent({
				delay: 2000,
			...
			if (multiTarget === false) {
				...
				for (var i = 0; i < this.battleScene.heroes.length; i++) {
					if (target === this.battleScene.heroes[i].playerInformation) {
						...
						timedEvent2 = this.battleScene.time.addEvent({
							delay: 1500,
							callback: this.deleteDamageIndicator,
							callbackScope: this
						});
	...
	createBattleSprites: function () {
		...
		for (var i = 0; i < 4; i++) {
			if (i === 0) {
				...
				var texthp1 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93, "hp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textmp1 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93 + 24, "mp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textName = this.add.text(760, 1024 - 3 * 95 - 78 + i * 93, players[i].unitName, {
					color: "#ffa500",
					align: "center",
					fontWeight: 'bold',
					font: '24px Arial',
				...
				for (var j = 0; j < players[i].unitSkills.length; j++) {
					if (j === 0) {
						...
						var text = this.scene.get("UIScene").add.text(1280 - 392 - j * 36 + 30,
							...
							": " + players[i].unitSkills[0].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 1) {
						...
						var text1 = this.scene.get("UIScene").add.text(1280 - 392 - j * 36 + 30,
							...
							": " + players[i].unitSkills[1].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 2) {
						...
						var text2 = this.scene.get("UIScene").add.text(1280 - 392 - j * 36 + 30,
							...
							": " + players[i].unitSkills[2].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 3) {
						...
						var text3 = this.scene.get("UIScene").add.text(1280 - 392 - j * 36 + 30,
							...
							": " + players[i].unitSkills[3].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 4) {
						...
						var text4 = this.scene.get("UIScene").add.text(1280 - 392 - j * 36 + 30,
							...
							": " + players[i].unitSkills[4].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
				...
				var texthp2 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93, "hp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textmp2 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93 + 24, "mp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textName2 = this.add.text(760, 1024 - 3 * 95 - 78 + i * 93, players[i].unitName, {
					color: "#ffa500",
					align: "center",
					fontWeight: 'bold',
					font: '24px Arial',
				...
				var texthp3 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93, "hp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textmp3 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93 + 24, "mp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textName3 = this.add.text(760, 1024 - 3 * 95 - 78 + i * 93, players[i].unitName, {
					color: "#ffa500",
					align: "center",
					fontWeight: 'bold',
					font: '24px Arial',
				...
				var texthp4 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93, "hp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textmp4 = this.add.text(980, 1024 - 3 * 95 - 78 + i * 93 + 24, "mp_player1", {
					color: "#000000",
					align: "center",
					fontWeight: 'bold',
					font: '13px Arial',
				...
				var textName4 = this.add.text(760, 1024 - 3 * 95 - 78 + i * 93, players[i].unitName, {
					color: "#ffa500",
					align: "center",
					fontWeight: 'bold',
					font: '24px Arial',
		...
		for (var i = 0; i < enemies.length; i++) {
			if (i == 0) {
				...
				var textName = this.add.text(20, 1024 - 3 * 95 - 40 + 36 + i * 120, enemies[i].unitName, {
					color: "#FF0000",
					fontWeight: 'bold',
					font: '24px Arial',
					wordWrap: {
				...
				for (var j = 0; j < enemies[i].unitSkills.length; j++) {
					if (j === 0) {
						...
						var text20 = this.scene.get("UIScene").add.text(180 + j * 36,
							...
							": " + enemies[i].unitSkills[0].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 1) {
						...
						var text21 = this.scene.get("UIScene").add.text(180 + j * 36,
							...
							": " + enemies[i].unitSkills[1].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 2) {
						...
						var text22 = this.scene.get("UIScene").add.text(180 + j * 36,
							...
							": " + enemies[i].unitSkills[2].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 3) {
						...
						var text23 = this.scene.get("UIScene").add.text(180 + j * 36,
							...
							": " + enemies[i].unitSkills[3].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
					...
					if (j === 4) {
						...
						var text24 = this.scene.get("UIScene").add.text(180 + j * 36,
							...
							": " + enemies[i].unitSkills[4].description, {
								color: "#ff2f2f",
								align: "center",
								fontWeight: 'bold',
								font: '24px Arial',
